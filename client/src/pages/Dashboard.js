...
const Dashboard = props => {
    ...
    const adddevice = () => {
        ...
        axios.post(baseURL + '/account/createDevice',{device})
        .then(results => {
            console.log(results)
        })
        .catch(error => {
...
{/* 
                ...
                <Row>
                    <Col xl={5}>
                        <Form.Control value={deviceName} onChange={(e) => {setdeviceName(e.target.value)}} style={{width:250}} />
                    </Col>
                    <Col xl={5}>
                        <Form.Control value={price} onChange={(e) => {setprice(e.target.value)}} style={{width:250}} />
                    </Col>
                    <Col xl={2}>
...
<br/><br/>
                ...
                <Row>
                    <Col xl={5}>
                        <Form.Control name="imageSource" type="file" onChange={(e) => {onImageChange(e)}} />
                    </Col>
                    <Col xl={5}>
                        <Form.Control value={imageDesc} name="imageDesc" onChange={(e) => {onImageChange(e)}} type="text" placeholder="Type your description..." />
                    </Col>
                    <Col xl={2}>
                        <Button onClick={addImageToGallery} variant="outline-success"><FcPlus size={30} /></Button>
                        <Button style={{marginLeft:10}} onClick={editList} variant="outline-info"><FcEditImage size={30} /></Button>
                    </Col>
                </Row>
